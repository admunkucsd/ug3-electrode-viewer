...
#include "UG3ElectrodeViewer.h" // update to point to your custom header file
...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "UG3 Electrode Viewer"; // Name of the plugin library
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		info->processor.creator = &(Plugin::createProcessor<UG3ElectrodeViewer>);
		break;
